...
export const SHOPIFY_ADMIN_GRAPHQL_API_ENDPOINT = "/admin/api/2025-10/graphql.json";
export const SHOPIFY_ADMIN_GRAPHQL_API_ENDPOINT_DEV_DASHBOARD = "/admin/api/2026-01/graphql.json";
